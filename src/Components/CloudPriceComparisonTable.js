...
const CloudPriceComparisonTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return params.row.awsInstanceType ? <div><p style={{ color: "black" }}>{params.row.awsInstanceType}</p><label >OnD: $ {parseFloat(params.row.awsPrice).toFixed(2)}/month</label><br />
          {parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) == Math.max(params.row.gcpPrice ? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) :null, params.row.awsPrice ? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) :null, params.row.azurePrice? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) :null) ? <div style={{ color: 'red' }}>OnD: $ {parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2)}/hour</div> :
            parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) == Math.min( params.row.gcpPrice? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) : 1000, params.row.awsPrice  ? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) : 1000, params.row.azurePrice? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) : 1000) ? <div style={{ color: 'green' }}>OnD: $ {parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2)}/hour</div> :
              <div>OnD: $ {parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2)}/hour</div>}
        </div> : ""
      }
    ...
    },
    {
      ...
      renderCell: (params) => {
        return params.row.azureInstanceType ? <div><p style={{ color: "black" }}>{params.row.azureInstanceType}</p><label>OnD: $ {parseFloat(params.row.azurePrice).toFixed(2)}/month</label><br />
          {parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) == Math.max(params.row.gcpPrice? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) : null, params.row.awsPrice ? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) :null, params.row.azurePrice ? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) :null) ? <div style={{ color: 'red' }}>OnD: $ {parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2)}/hour</div> :
           parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) == Math.min(params.row.gcpPrice ? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) : 1000, params.row.awsPrice? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) : 1000, params.row.azurePrice ? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) : 1000) ? <div style={{ color: 'green' }}>OnD: $ {parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2)}/hour</div> :
              <div>OnD: $ {parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2)}/hour</div>}
        </div> : "";
      }
    },
    {
      ...
      renderCell: (params) => {
        return params.row.gcpArrayInstanceType ? <div><p style={{ color: "black" }}>{params.row.gcpArrayInstanceType}</p><label>OnD: $ {parseFloat(params.row.gcpPrice).toFixed(2)}/month</label><br />
          {
            parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) == Math.max(params.row.gcpPrice? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) : null, params.row.awsPrice ? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) :null, params.row.azurePrice ? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) :null) ? <div style={{ color: 'red' }}>OnD: $ {parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2)}/hour</div> :
              parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) == Math.min(params.row.gcpPrice ? parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2) : 1000, params.row.awsPrice ? parseFloat(parseInt(params.row.awsPrice) / 720).toFixed(2) : 1000, params.row.azurePrice ? parseFloat(parseInt(params.row.azurePrice) / 720).toFixed(2) : 1000) ? <div style={{ color: 'green' }}>OnD: $ {parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2)}/hour</div> :
                <div>OnD: $ {parseFloat(parseInt(params.row.gcpPrice) / 720).toFixed(2)}/hour</div>
          }
